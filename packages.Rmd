...
* **[googleAnalyticsR](http://code.markedmondson.me/googleAnalyticsR/)** -- this is a great package for accessing Google Analytics data. It uses the v4 API from Google Analytics which (right now) makes it unique.
...
* **[bigQueryR](http://code.markedmondson.me/bigQueryR/) -- a package for accessing Google BigQuery
