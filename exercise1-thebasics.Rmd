...
12^2
```
That's just simple math. It's not too impressive, but it shows executing commands directly in the console.
...
In some cases, `=` will work, too, and there _are_ cases where you use `=` in R, but `<-` is very common, and it should quickly become second nature. When you type this in, you won't see anything else in the console. But, if you look in the **Environment** tab in the top right pane, you should now see your variable:
...
For now, go ahead and click **Source**. It doesn't look like much happened, but, if you now check your **Environment** window, you will see a new object called **gaData**. Double-click on that, and the **gaData** data frame will load in a new tab next to your script.
