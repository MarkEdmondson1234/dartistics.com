...
[HTMLwidgets](http://gallery.htmlwidgets.org/) is a library you may not use directly, but enables package  creators to easily port JavScript visualisations to R for display.  Since JavaScript has arguably the best visualisation libraries out there, led by [https://d3js.org/](https://d3js.org/), this opens up many opportunities to link R data with JavaScript interactivity.
...
Good for time-series.  Click plot to zoom
...
You need to pay to use this commercially, but very nice library with lots of options and shortcuts to plot R objects - the below is a correlation table:
