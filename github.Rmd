...
* Github is a bit notorious for being arcane, so hang in there and stick with simple tasks for now.  If something goes wrong you can always [save your work to a different folder, delete everything and redownload again](https://xkcd.com/1597/).  You will still get a lot of value without knowing its intricies.
