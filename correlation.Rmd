...
The below example uses the web data dataset used in Exercise 4:
...
## get rid of first colum as its just row numbers
web_data <- web_data[, -1]
...
The table is mirrored in the diagonal and provides the _correlation coefficient_ (aka, "_r_") between each pair of values that intersect in the cell. 1 means a perfect correlation, 0 no correlation and -1 means a perfect negative correlation.
